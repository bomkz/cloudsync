...
type UpdatePilotPilotStruct struct {
	Name  string     `json:"name"`
	Pilot PilotsFile `json:"pilotFile"`
}

type GetPilotReqStruct struct {
	Req   string                `json:"request"`
	Pilot GetPilotReqBodyStruct `json:"body"`
	Auth  string                `json:"auth"`
}

type GetPilotReqBodyStruct struct {
	Name    string `json:"name"`
	Version int    `json:"version"`
}

type GetPilotInfoReqStruct struct {
	Req  string `json:"request"`
	Name string `json:"body"`
	Auth string `json:"auth"`
}

type UpdatePilotRespStruct struct {
	Req  string `json:"request"`
	Info string `json:"body"`
}

type GetPilotInfoRespStruct struct {
	Req     string `json:"request"`
	Content int    `json:"body"`
}

type GetPilotRespStruct struct {
	Req   string     `json:"request"`
	Pilot PilotsFile `json:"body"`
}
...
type GetPilotsResponseStruct struct {
	Request string   `json:"type"`
	Body    []string `json:"body"`
}
